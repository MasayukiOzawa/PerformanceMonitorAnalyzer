...
### ナレッジベース
- [🧭 カウンター選択エリアの表示制御とリサイズ対応](../knowledge/70-カウンター選択エリアの表示制御とリサイズ対応.md) - 表示/非表示切替、GridSplitterによる横幅調整を追加
...
- **📊 グラフ表示**: ScottPlot.WPFによる時系列データの可視化
  ...
  - **📉 値モード切り替え**: 生値と前回差分（current - previous）の切り替え機能
...
- **データ可視化**: パフォーマンスデータの階層表示とタブ形式データテーブル
  ...
  - **🧭 選択エリア制御**: カウンター選択エリアの表示/非表示、横幅リサイズ
