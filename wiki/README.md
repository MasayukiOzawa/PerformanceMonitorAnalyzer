...
### ナレッジベース
- [🔄 Y軸ズーム機能の実装](../knowledge/70-Y軸ズーム機能の実装.md) - マウス操作によるY軸ズーム・パン機能の詳細実装
...
- **📊 グラフ表示**: ScottPlot.WPFによる時系列データの可視化
  ...
  - **🆕 Y軸ズーム・パン機能**: マウス操作による詳細な値分析
    - **マウスホイールズーム**: Y軸範囲の拡大・縮小操作
    - **ドラッグパン**: 中ボタンまたはCtrl+左ボタンドラッグでY軸範囲を上下移動
    - **キーボードショートカット**: F5（Y軸リセット）、Ctrl+R（全体リセット）
    - **詳細分析**: 100→95-100のような細かな値の動きを確認可能
